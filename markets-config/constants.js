...
// ----------------
const OPTIMAL_UTILIZATION_RATE = new BigNumber(0.8).times(RAY);
const EXCESS_UTILIZATION_RATE = new BigNumber(0.2).times(RAY);
const APPROVAL_AMOUNT_LENDING_POOL = '1000000000000000000000000000';
const TOKEN_DISTRIBUTOR_PERCENTAGE_BASE = '10000';
const MOCK_USD_PRICE_IN_WEI = '5848466240000000';
const USD_ADDRESS = '0x10F7Fc1F91Ba351f9C629c5947AD69bD03C05b96';
const AAVE_REFERRAL = '0';
...
const chainlinkEthUsdAggregatorProxy = {
  main: '0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419',
  kovan: '0x9326BFA02ADD2366b30bacB125260Af641031331',
